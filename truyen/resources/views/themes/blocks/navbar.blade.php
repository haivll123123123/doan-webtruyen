                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a href="#" title="Truyện Tiên Hiệp">{{$categories->name}}</a></li>
                                    @endforeach
                                </ul>
                            </div>
                            <div class="col-md-4">
                                <ul class="dropdown-menu">
                                    @foreach($category2 as $categories)
                                    <li><a href="#" title="Truyện Xuyên Không">{{$categories->name}}</a></li>
                                    @endforeach
                                </ul>
                            </div>
                            <div class="col-md-4">
                                <ul class="dropdown-menu">
                                    @foreach($category3 as $categories)
                                    <li><a href="#" title="Truyện Đam Mỹ">{{$categories->name}}</a></li>
                                    @endforeach
                                </ul>
                            </div>
                        </div>
